...
int main() {
    ...
    while (true) {
        ...
        gpio_put(PIN_LED, 1);
        // hw_VEML6030_set_integration_time(als, 100);
        // printf("Integration time %d ms\n", als->curr_integ_time_ms);
        // hw_VEML6030_set_gain(als, 2.0);
        // sleep_ms(als->curr_integ_time_ms + 50);
        // light = hw_VEML6030_read_lux(als);
        // printf("Light @ 2x gain = %f\n", light);

        // hw_VEML6030_set_gain(als, 1.0);
        // sleep_ms(als->curr_integ_time_ms + 50);
        // light = hw_VEML6030_read_lux(als);
        // printf("Light @ 1x gain = %f\n", light);

        // hw_VEML6030_set_gain(als, 0.25);
        // sleep_ms(als->curr_integ_time_ms + 50);
        // light = hw_VEML6030_read_lux(als);
        // printf("Light @ 1/4x gain = %f\n", light);

        // hw_VEML6030_set_gain(als, 0.125);
        // sleep_ms(als->curr_integ_time_ms + 50);
        // light = hw_VEML6030_read_lux(als);
        // printf("Light @ 1/8x gain = %f\n", light);

        // hw_VEML6030_set_integration_time(als, 25);
        // printf("Integration time %d ms\n", als->curr_integ_time_ms);
        // hw_VEML6030_set_gain(als, 2.0);
        // sleep_ms(als->curr_integ_time_ms + 50);
        // light = hw_VEML6030_read_lux(als);
        ...
        // hw_VEML6030_set_integration_time(als, 400);
        // printf("Integration time %d ms\n", als->curr_integ_time_ms);
        // hw_VEML6030_set_gain(als, 0.125);
        // sleep_ms(als->curr_integ_time_ms + 50);
        // light = hw_VEML6030_read_lux(als);
